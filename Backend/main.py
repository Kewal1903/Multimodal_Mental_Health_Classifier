...
WEIGHTS = {
    'text': 0.5,
    'image': 0.5,
    'audio': 0.0  # We'll add this when your teammate sends the file
}
...
async def predict(
    ...
    # (We will add audio_probs_dict here later)
    ...
    # (We will add audio array here later)
    ...
    return {
        ...
        "audio_probabilities": {}  # Placeholder for now
    }
